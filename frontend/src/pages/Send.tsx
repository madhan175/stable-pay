...
const Send = () => {
  ...
  const estimateGasFee = async () => {
    ...
    try {
      ...
      // Import getSafeFeeData from blockchain.ts to handle RPC errors gracefully
      const { getSafeFeeData } = await import('../utils/blockchain');
  ...
  return (
    <div className="max-w-2xl mx-auto px-3 sm:px-4 lg:px-8 py-6 sm:py-12 lg:py-16 overflow-x-hidden w-full max-w-full">
          ...
          <div className="mt-8">
            ...
            {txStatus === 'success' && (
              <div className="bg-green-50 border border-green-200 rounded-2xl p-6 text-center">
                ...
                <h3 className="text-xl font-bold text-green-900 mb-2">Payment Sent Successfully!</h3>
                <p className="text-sm text-green-800 mb-6">
                  Your payment of {usdtAmount} USDT has been sent to the merchant.
                </p>
                
                <div className="bg-white rounded-xl p-4 border border-green-100 mb-6 text-left">
                  <div className="text-xs text-gray-500 mb-1 uppercase font-bold tracking-wider">Transaction Hash</div>
                  <div className="text-xs font-mono text-gray-800 break-all bg-gray-50 p-2 rounded border border-gray-100 mb-3 cursor-all-scroll overflow-x-auto">
                    {txHash}
                  </div>
                  <a
                    ...
                    className="flex items-center justify-center space-x-2 text-sm text-blue-600 hover:text-blue-700 font-medium py-2 border border-blue-100 rounded-lg hover:bg-blue-50 transition-colors"
                  >
                    <span>Track on Block Explorer</span>
