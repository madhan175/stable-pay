    ...
    <div className="max-w-4xl mx-auto px-3 sm:px-4 lg:px-8 py-6 sm:py-12 lg:py-16">
      ...
      {!isConnected ? (
        <div className="text-center">
          <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl sm:shadow-2xl p-6 sm:p-12 border border-gray-100">
            <Wallet className="w-12 h-12 sm:w-16 sm:h-16 text-gray-400 mx-auto mb-4 sm:mb-6" />
        ...
        <div className="space-y-4 sm:space-y-6 lg:space-y-8">
          ...
          <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl sm:shadow-2xl p-4 sm:p-6 lg:p-8 border border-gray-100">
            <div className="flex items-center justify-between mb-4 sm:mb-6">
              <h2 className="text-xl sm:text-2xl font-semibold text-gray-900">Wallet Information</h2>
              <button
                onClick={fetchData}
                disabled={isLoading}
                className="p-2.5 sm:p-2 text-gray-500 hover:text-blue-600 active:bg-blue-50 rounded-lg transition-colors duration-200 touch-manipulation"
                aria-label="Refresh"
              >
            ...
            <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
              <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <button
                    onClick={copyAddress}
                    className="text-blue-600 hover:text-blue-700 active:text-blue-800 transition-colors duration-200 touch-manipulation p-1"
                    aria-label="Copy address"
                  >
                    {copied ? <Check className="w-4 h-4" /> : <Copy className="w-4 h-4" />}
                  </button>
                </div>
                <p className="text-sm sm:text-base lg:text-lg font-mono text-gray-900 break-all">
                  {account}
                </p>
              </div>

              <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                <span className="text-xs sm:text-sm font-medium text-gray-600">USDT Balance</span>
                <div className="flex items-center space-x-2 flex-wrap">
                  <span className="text-2xl sm:text-3xl font-bold text-gray-900">
                    ${displayBalance}
                  </span>
                  <span className="text-xs sm:text-sm text-gray-500">USDT</span>
                </div>
